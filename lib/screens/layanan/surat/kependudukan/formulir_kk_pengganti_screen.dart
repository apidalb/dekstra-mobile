...
class _KkPenggantiState extends State<FormulirKkPenggantiScreen> {
  ...
  Future<Map<String, dynamic>> _buildPayload() async => {
    'nama_kepala_keluarga' : _namaKepalaCtrl.text,
    'nomor_telepon'        : _noTelpCtrl.text,
    'alamat'               : _alamatCtrl.text,
    'rt'                   : _rtCtrl.text,
    'rw'                   : _rwCtrl.text,
    'kode_pos'             : _kodePosCtrl.text,
    'nama_ketua_rt'        : _namaRtCtrl.text,
    'nama_ketua_rw'        : _namaRwCtrl.text,
    'anggota_keluarga'     : _anggota.map((a) => {
      'nama_lengkap'            : a.namaCtrl.text,
      'nik'                     : a.nikCtrl.text,
      'jenis_kelamin'           : a.jk,
      'alamat_sebelumnya'       : a.alamatCtrl.text,
      'tempat_lahir'            : a.tempatCtrl.text,
      'tanggal_lahir'           : ddmmyyyyToIso(a.tglCtrl.text),
      'agama'                   : a.agama,
      'status_perkawinan'       : a.statusKawin,
      'status_hubungan_keluarga': a.shdk,
