...
class _KematianState extends State<SuratKeteranganKematianScreen> {
  ...
  Future<Map<String, dynamic>> _buildPayload() async => {
    'nama_almarhum'         : _namaCtrl.text,
    'nik_almarhum'          : _nikCtrl.text,
    'tempat_lahir_almarhum' : _tempatCtrl.text,
    'tanggal_lahir_almarhum': ddmmyyyyToIso(_tglLahirCtrl.text),
    'agama_almarhum'        : _agama,
    'pekerjaan_almarhum'    : _pekerjaanCtrl.text,
    'kewarganegaraan_almarhum': _kwrg,
    'alamat_almarhum'       : _alamatCtrl.text,
    'tanggal_meninggal'     : ddmmyyyyToIso(_tglMeninggalCtrl.text),
    'tempat_meninggal'      : _tempatMeninggalCtrl.text,
    'status_hubungan_pengaju': _statusHub,
