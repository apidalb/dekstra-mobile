...
class SuratPengantarSkckScreen extends StatefulWidget {
  ...
  @override
  State<SuratPengantarSkckScreen> createState() =>
      _SuratPengantarSkckScreenState();
}

class _SuratPengantarSkckScreenState
    extends State<SuratPengantarSkckScreen> {
  ...
  void dispose() {
    for (final c in [
      ...
      _pekerjaanCtrl, _alamatCtrl, _keperluanCtrl, _keteranganCtrl,
    ]) { c.dispose(); }
    super.dispose();
  }
  ...
  void _submit() async {
    ...
    if (!mounted) return;
    showSuccessDialog(context, 'Surat Pengantar SKCK');
  }
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            namaSuratCard('SURAT PENGANTAR SKCK'),
            ...
            sectionCard(children: [
              ...
              fieldLabel('Keperluan SKCK', required: true),
              const SizedBox(height: 6),
              TextFormField(
                ...
                style: GoogleFonts.poppins(fontSize: 13),
                decoration: const InputDecoration(
                    hintText: 'Contoh: melamar pekerjaan, keperluan visa'),
